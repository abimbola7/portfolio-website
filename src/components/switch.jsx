    ...
    <>
      {
        mounted && (
          ...
          className='w-16 px-1 py-1 bg-black cursor-pointer rounded-3xl relative'>
            <div 
            className={`bg-[#f7801e] rounded-full w-7 h-7 transition-transform duration-300 ${currentTheme === "dark" ? "translate-x-full" : "translate-x-0"} flex justify-between items-center`}
            >
            </div>
